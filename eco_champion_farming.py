...
class MinetestMonitor:
    ...
    def is_farming_related(self, block):
        """
        Check if a block is farming/planting related.
        Only counts items that represent actual planting activity.
        """
        # Items to count (things that get planted/placed in the world)
        farming_items = [
        ...
        # Items to exclude (not actual planting)
        exclude_items = [
            'farming:bread',       # Food items
            'farming:flour',
            'farming:soil',        # Farmland (not a plant)
            'farming:soil_wet',
        ]
        ...
        # Check if it matches farming items
    ...
    def print_eco_leaderboard(self):
        ...
        print("\nSCORING SYSTEM:")
        print("  Farming/Planting:   +10 points each (adds to world)")
